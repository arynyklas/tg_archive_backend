...
class Message(BaseModel):
    ...
    tg_message_id: Mapped[int] = mapped_column(tg_id_type, index=True, nullable=False)
    reply_to_tg_message_id: Mapped[int | None] = mapped_column(tg_id_type, index=True, nullable=True)
